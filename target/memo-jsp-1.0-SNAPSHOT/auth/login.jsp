...
<body class="font-sans text-gray-900 antialiased">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
            ...
            <%-- Ini adalah isi dari login.blade.php --%>
            ...
            <form method="POST" action="${pageContext.request.contextPath}/auth/login">
                ...
                <div class="flex justify-between items-center mt-6">
                    <label for="remember_me" class="inline-flex items-center">
                        <input id="remember_me" type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700" name="remember">
                        <span class="ms-2 text-sm text-gray-600 dark:text-gray-400">Remember me</span>
                    </label>
                    
                    <span class="text-sm text-gray-600 dark:text-gray-400">
                        New user? 
                        <a href="${pageContext.request.contextPath}/auth/register" class="font-semibold text-blue-600 dark:text-blue-400 hover:underline ms-1">
                            Register Here!
                        </a>
                    </span>
                </div>
